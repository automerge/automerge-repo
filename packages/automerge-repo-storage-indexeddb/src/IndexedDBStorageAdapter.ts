/**
 * The core IndexedDB storage adapter (runs wherever it is constructed — main
 * thread or a Worker). For the off-main-thread variant see
 * {@link IndexedDBWorkerStorageAdapter}.
 *
